...
@SpireInitializer
public class ModManager implements ISubscriber, EditStringsSubscriber, PostInitializeSubscriber, OnCardUseSubscriber {
    ...
    public static void initialize() {
        Log.logger.info("========================= Initializing {} Mod. =========================", ModPath.ModName);
        new ModManager();
        Log.logger.info("========================= /{} Initialized. Hello World./ =========================", ModPath.ModName);
    }
...
//        AbstractDungeon.actionManager.addToBottom(new RunTopLevelEffectAction(new SimplePlayVideoEffect(ModPath.makeVideoPath("1.webm"))));
    }
